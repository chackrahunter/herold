...
public final class Stil {
    ...
    /** Farbe zu einem Rhythmusurteil. */
    public static int befund(int urteil) {
        if (urteil == RhythmusAnalyse.UNREGELMAESSIG) return BEFUND_AUFFAELLIG;
        if (urteil == RhythmusAnalyse.ZU_WENIG
                || urteil == RhythmusAnalyse.UNSICHER)  return BEFUND_UNKLAR;
        return BEFUND_GLEICHMAESSIG;
    }
